package diettelPolymorphismAndInterfaces;

import diettelInheritance.BasePlusCommissionEmployee;
import diettelInheritance.CommissionEmployee;

public class PolymorphismTest {
    public static void main(String[] args) {
        CommissionEmployee commissionEmployee = new CommissionEmployee("Prince","Nwaimo","222-22-2222",1000,0.06);
