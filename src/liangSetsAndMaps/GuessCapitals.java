...
public class GuessCapitals {
    public static void main(String[] args) {
        ...
        stateCapitals.put("Abia", "Umuahia");
        stateCapitals.put("Adamawa", "Yola");
        stateCapitals.put("Akwa Ibom", "Uyo");
        stateCapitals.put("Anambra", "Awka");
        stateCapitals.put("Bauchi", "Bauchi");
        stateCapitals.put("Bayelsa", "Yenegoa");
        stateCapitals.put("Imo", "Owerri");
        stateCapitals.put("Ebonyi", "Abakiliki");
